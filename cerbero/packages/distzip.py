...
class DistZip(PackagerBase):
    ...
    def _create_zip(self, output_dir, package_type, files, force,
                        package_prefix):
        ...
        for f in files:
            ...
            zip_file.write(filepath, os.path.join(package_prefix, f))
        zip_file.close()
