...
class Variants(object):
    ...
    def reset(self):
        ...
        for v in self.__unknown_variants:
            delattr(self, v)
    ...
    def set_bool(self, key):
        ...
        if key not in self.__bool_variants:
            ...
            self.__unknown_variants.append(key)
    ...
    def __setattr__(self, attr, value):
        ...
        if attr in ['_Variants__unknown_variants', '_Variants__overridden_variants']:
            return
